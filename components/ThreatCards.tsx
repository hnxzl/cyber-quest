...
const ThreatCards: React.FC = () => {
  ...
  const threats: ThreatCardData[] = [
    {
      ...
      icon: "🎣",
      shortDesc:
        "Penipuan melalui link atau pesan palsu untuk mencuri data pribadi",
      detailedInfo: {
        description:
          "Phishing adalah teknik penipuan siber dimana penyerang menyamar sebagai entitas tepercaya untuk mencuri informasi sensitif seperti password, nomor kartu kredit, atau data pribadi lainnya.",
        examples: [
    ...
    },
    {
      ...
      icon: "🧠",
      shortDesc:
        "Manipulasi psikologis untuk membuat korban memberikan informasi rahasia",
      detailedInfo: {
        description:
          "Social Engineering adalah seni manipulasi manusia untuk mendapatkan akses tidak sah ke sistem atau informasi. Penyerang mengeksploitasi sifat manusia seperti kepercayaan, rasa takut, atau keinginan membantu.",
        examples: [
    ...
    },
    {
      ...
      icon: "🔒",
      shortDesc:
        "Malware yang mengunci file dan meminta tebusan untuk membukanya",
      detailedInfo: {
        description:
          "Ransomware adalah jenis malware yang mengenkripsi file korban dan meminta pembayaran tebusan (ransom) untuk memberikan kunci dekripsi. Ini adalah salah satu ancaman siber paling merusak untuk individu dan organisasi.",
        examples: [
    ...
    },
    {
      ...
      icon: "🔑",
      shortDesc:
        "Penggunaan password yang mudah ditebak memudahkan akses tidak sah",
      detailedInfo: {
        description:
          "Password lemah adalah salah satu celah keamanan paling umum. Password yang mudah ditebak, terlalu pendek, atau menggunakan informasi pribadi dapat dengan mudah dipecahkan oleh penyerang menggunakan berbagai teknik.",
        examples: [
  ...
  const ThreatCard: React.FC<{ threat: ThreatCardData }> = ({ threat }) => (
    <div
      ...
      className={`${
        threat.bgColor
      } border-2 rounded-lg p-4 cursor-pointer hover:shadow-md transition-all duration-200 ${
    ...
    >
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1">
          <h3 className={`font-semibold text-lg ${threat.color}`}>
            {threat.title}
          </h3>
            ...
            <div className="mt-4 space-y-4">
              <div>
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  {threat.detailedInfo.description}
                </p>
              </div>
                ...
                <ol className="space-y-1">
                  {tip.detailedInfo.steps.map((step, idx) => (
                    <li
                      ...
                      className="text-gray-700 text-sm flex items-start"
                    >
                      <span className={`${tip.color} mr-2 font-medium`}>
                        {idx + 1}.
                      </span>
                      {step}
                    </li>
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">
            Klik pada setiap card untuk mempelajari lebih detail tentang ancaman
      ...
      <div className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-100 rounded-lg p-6 text-center">
        ...
        <p className="text-gray-600 text-sm">
          Dengan memahami ancaman dan menerapkan tips keamanan, kita dapat
          menciptakan internet yang lebih aman untuk semua.
        </p>
      </div>
    </div>
  );
