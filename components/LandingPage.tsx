        ...
        <div className="max-w-6xl mx-auto px-4 py-6 flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <button
              ...
              className="bg-gradient-to-r from-green-500 to-blue-500 text-white px-4 py-2 rounded-xl font-semibold hover:from-green-600 hover:to-blue-600 transition-all shadow-lg hover:shadow-xl"
            >
              🎓 Edukasi
            </button>
            <button
              onClick={() => router.push("/presentasi")}
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-4 py-2 rounded-xl font-semibold hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg hover:shadow-xl"
            >
              📽️ Presentasi
            </button>
            <button
      ...
      <div className="max-w-5xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border border-white/30 shadow-xl max-w-2xl mx-auto">
            <p className="text-base md:text-lg text-gray-800 flex items-center justify-center flex-wrap">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-8 shadow-xl border border-purple-200 mb-12">
          <h3 className="text-2xl font-bold text-center mb-6 flex items-center justify-center">
            <span className="text-3xl mr-3">📽️</span>
            Lihat Presentasi Keamanan Digital
          ...
          <div className="text-center">
            <button
              onClick={() => router.push("/presentasi")}
              className="bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold py-4 px-8 rounded-2xl shadow-lg transition-all transform hover:scale-105 text-lg"
            >
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl p-8 shadow-xl border border-yellow-200 mb-12">
          <h3 className="text-xl md:text-2xl font-bold text-center mb-6 flex items-center justify-center flex-wrap">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/70 rounded-xl p-4 border border-yellow-300">
              <p className="text-base md:text-lg font-medium text-gray-800 mb-2 flex items-center flex-wrap">
                <span className="text-2xl mr-2">📱</span>
                <span>95% remaja Indonesia aktif di media sosial</span>
              </p>
            ...
            <div className="bg-white/70 rounded-xl p-4 border border-yellow-300">
              <p className="text-base md:text-lg font-medium text-gray-800 mb-2 flex items-center flex-wrap">
                <span className="text-2xl mr-2">🎣</span>
                <span>1 dari 5 remaja pernah kena phishing</span>
              </p>
              <p className="text-gray-600 text-sm">
        ...
        {/* Education Section */}
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-8 shadow-xl border border-green-200 mb-12">
          <h3 className="text-2xl font-bold text-center mb-6 flex items-center justify-center">
            <span className="text-3xl mr-3">🎓</span>
            Pelajari Keamanan Digital
          ...
          <div className="text-center">
            <button
              onClick={() => router.push("/education")}
              className="bg-gradient-to-r from-green-500 to-emerald-500 text-white font-bold py-4 px-8 rounded-2xl shadow-lg transition-all transform hover:scale-105 text-lg"
            >
              <span className="text-xl mr-3">📚</span>
              Mulai Belajar
            </button>
        ...
        {/* Footer */}
        <div className="mt-12 text-center">
          <p className="text-gray-500 text-sm flex items-center justify-center flex-wrap">
